      ...
      <div class="page-navigation clear">
         ...
         <?php if ( !is_search() ) { ?>
            <?php if (get_next_posts_link()) : ?>
               <div class="nav-previous"><?php next_posts_link(__('<span><i class="fa fa-arrow-circle-o-left"></i></span> More posts', 'masonic')); ?></div>
            <?php endif; ?>
...
if (!function_exists('masonic_posted_on')) :
   ...
   function masonic_posted_on() {
      ...
      echo '<div class="entry-author vcard author fa fa-user"><span class="author-style-override">' . esc_html(get_the_author()) . '</span></div>';
